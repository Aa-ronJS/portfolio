...
(function () {
  ...
  function ics(events, calName) {
    ...
    events.forEach(function (e) {
      ...
      if (e.startHour != null) { L.push('DTSTART:' + icsLocal(e.start, e.startHour, 0), 'DTEND:' + icsLocal(e.end || e.start, e.endHour != null ? e.endHour : e.startHour + 1, 0)); }
      ...
      if (e.alarmHour != null) { L.push('BEGIN:VALARM', 'ACTION:DISPLAY', 'DESCRIPTION:' + escText(e.summary), 'TRIGGER;VALUE=DATE-TIME:' + icsStamp(new Date(e.start + 'T' + pad(e.alarmHour) + ':00:00')), 'END:VALARM'); }
      L.push('END:VEVENT');
    });
  ...
  function googleUrl(e) { var dates = e.startHour != null ? icsLocal(e.start, e.startHour, 0) + '/' + icsLocal(e.end || e.start, e.endHour != null ? e.endHour : e.startHour + 1, 0) : icsDate(e.start) + '/' + icsDate(e.end || addDays(e.start, 1)); return 'https://calendar.google.com/calendar/render?action=TEMPLATE&text=' + encodeURIComponent(e.summary) + '&dates=' + dates + '&details=' + encodeURIComponent(e.description || '') + '&location=' + encodeURIComponent(e.location || ''); }
