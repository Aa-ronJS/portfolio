...
const wh = require(require('path').join(__dirname, '../../../..', 'quote-and-chase-landing') + '/api/stripe-webhook.js');
const renew = require(require('path').join(__dirname, '../../../..', 'quote-and-chase-landing') + '/api/renew.js').default;
const portal = require(require('path').join(__dirname, '../../../..', 'quote-and-chase-landing') + '/api/portal.js').default;
const sl = require(require('path').join(__dirname, '../../../..', 'quote-and-chase-landing') + '/api/setup-link.js').default;
