...
You're on the list for the hosted version of Quote & Chase: same tool,
...
Thanks for buying Quote & Chase. Two downloads, then one command.

1. Set up Claude Code: [download link for your computer]. Unzip,
   double-click the file starting with "1". It explains itself.
2. Install Quote & Chase: [download link]. Unzip, double-click the
   installer, then open "START HERE - Quote and Chase.txt" in the
