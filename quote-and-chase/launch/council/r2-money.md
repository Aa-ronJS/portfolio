...
and at 12 messages a fully-quiet quote-and-chase cycle (send + 3 nudges = 4) times three jobs lands
...
Confirmed in the code, so this is a change, not a plan: `quote-and-chase-landing/public/config.js:21`
