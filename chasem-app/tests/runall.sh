...
SUITES="apptest/flow apptest/e2e apptest/sendflow apptest/enquiry apptest/invguard apptest/auto apptest/geom
        ...
        apptest/prefill-e2e apptest/setup-link apptest/calendar-app apptest/testdrive apptest/hostile apptest/usable apptest/wall apptest/signin apptest/cardpay apptest/landing2 apptest/landing-welcome apptest/council6
