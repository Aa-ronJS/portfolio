...
const wh = require(require('path').join(__dirname, '../../../..', 'chasem-landing') + '/api/stripe-webhook.js').default;
...
(async () => {
  ...
  const topup = require(require('path').join(__dirname, '../../../..', 'chasem-landing') + '/api/topup.js').default;
  ...
  // ---- 11. the second phone
  const seat = require(require('path').join(__dirname, '../../../..', 'chasem-landing') + '/api/seat.js').default;
