...
(async () => {
  ...
  ok(/Texts end with your number, 0412 000 000\./.test(sd) && !/Add your mobile/.test(sd), 'Set-up states the number the texts give out');
  ...
  ok(/Texts come from a number that cannot take replies\. Add your mobile in Business above\./.test(sd), 'Set-up warns when hosted sending has no mobile to give');
