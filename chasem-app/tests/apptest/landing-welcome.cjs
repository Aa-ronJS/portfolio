...
(async () => {
  ...
  ok(/Bring in the quotes you already have out/.test(t) && /Paste a text you sent, drop in the file from your quoting app, or type them in/.test(t), 'the next step is bringing in his quotes, by himself');
