...
dist/chasem-<trading-name>.zip, which is the normal customer
...
def main():
    ...
    top = build / "Chasem for Painters"
    top.mkdir(parents=True)
    for f in ["READ ME FIRST.txt", "Install Chasem (Windows).bat", "Install Chasem (Mac).command"]:
