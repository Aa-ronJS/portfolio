...
const app = read(join(here, "../../chasem-app/config.js"));
...
must(has(APP.signup_url), "the app can sign someone up", "set signup_url in chasem-app/config.js to <relay>/api/signup");
