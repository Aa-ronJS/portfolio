...
(function () {
  ...
  function defaults() {
    ...
    return {
      ...
      sending: { server: '', token: '', server_has_creds: false, hosted: false, hosted_until: '', hosted_name: '', hosted_cancelled: false, hosted_past_due: false, renew_checked: '', auto_topup: false, twilio_sid: '', twilio_token: '', twilio_service: '', twilio_from: '', resend_key: '', resend_from: '', auto_sms: true, auto_email: true, email_quotes: true },
      ...
      wording: {
        ...
        terms: ['Paint prices are held until the date above; supplier increases after it are passed on at cost.',
          'Quantities are for pricing and are not re-measured on completion. If the rooms measure more than 5% larger than the sizes given, we confirm any change with you in writing before starting.',
