...
(function () {
  ...
  function viewRoom(job, rid) {
    ...
    if (!ext) {
      ...
      var mopts = { count: function () { return room.walls.length; }, ceiling: function () { return { m: n(room.H) || n(S.rules.ceiling_height_m) || 2.4, assumed: !n(room.H) }; }, onHeight: function (m, how, err) { if (room.H_err != null && err > room.H_err) return; room.H = Math.round(m * 100) / 100; room.H_from = how; room.H_err = err; save(); },
